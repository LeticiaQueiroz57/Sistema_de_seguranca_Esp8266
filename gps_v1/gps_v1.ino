...
// No ESP8266, usamos SoftwareSerial pois a HardwareSerial está ocupada pelo USB
#define GPS_RX_PIN D1  // Conectar ao pino TX do módulo GPS
#define GPS_TX_PIN D2  // Conectar ao pino RX do módulo GPS
...
const char* ssid = "yourSSID";       // Your WiFi network name (SSID)
...
// API Authentication
const char* apiKey = "G999FeV5Kn5V";    // Your unique GeoLinker API key
...
const uint8_t offlineBufferLimit = 10;  // Maximum offline records to store
